...
default_args = {
    'start_date': datetime(2023, 1, 5, 11, tzinfo=local_tz),
    'owner': 'Airflow',
...
with DAG(dag_id='tz_dag', schedule_interval=timedelta(days=1), default_args=default_args, catchup=True) as dag:
